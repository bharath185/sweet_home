  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-br from-[#0c1527] via-[#13223f] to-[#09101f] text-slate-100 flex items-center justify-center p-4 sm:p-8 lg:p-12 overflow-x-hidden selection:bg-sky-500 selection:text-white">
      ...
      <div className="relative z-10 w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
        ...
        {/* RIGHT COLUMN: Attractive Graded Slate Login Card */}
        <div className="lg:col-span-5 flex flex-col justify-center max-w-md mx-auto w-full">
          <div className="relative bg-gradient-to-b from-[#111e38]/95 to-[#0b1426]/95 border border-slate-700/70 rounded-3xl p-8 sm:p-10 shadow-2xl shadow-black/40 backdrop-blur-xl overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-sky-500 via-indigo-600 to-purple-600 shadow-lg shadow-sky-500/25 flex items-center justify-center text-white border border-white/20">
            ...
            {errorMessage && (
              <div className="mb-6 p-3.5 rounded-xl bg-rose-500/15 border border-rose-500/30 text-rose-300 text-xs font-medium flex items-center gap-2.5 animate-in fade-in">
            ...
            <form onSubmit={handleFormSubmit} autoComplete="off" className="space-y-5">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3.5 py-3 bg-[#080f1e]/90 border border-slate-700/80 rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-500/20 transition-all shadow-inner"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-3 bg-[#080f1e]/90 border border-slate-700/80 rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-500/20 transition-all shadow-inner"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between text-xs pt-1">
                <label className="flex items-center gap-2.5 cursor-pointer text-slate-400 hover:text-slate-200 select-none transition-colors">
                  <input
                    ...
                    className="rounded bg-[#080f1e] border-slate-700 text-sky-500 focus:ring-0 focus:ring-offset-0 cursor-pointer w-4 h-4"
                  />
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 rounded-xl text-xs font-bold text-white shadow-xl transition-all flex items-center justify-center gap-2 active:scale-[0.98] bg-gradient-to-r from-sky-500 via-indigo-600 to-indigo-700 hover:from-sky-400 hover:via-indigo-500 hover:to-indigo-600 shadow-sky-500/25 hover:shadow-sky-500/40 cursor-pointer disabled:opacity-50 mt-2"
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-8 pt-4 border-t border-slate-800 flex items-center justify-center gap-2 text-[10px] text-slate-400 font-medium">
