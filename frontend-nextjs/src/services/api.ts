...
export const fallbackCatalog: CatalogItem[] = [
  ...
  { id: 'pendantLamp', name: 'Ceiling Pendant Lamp', category: 'Lighting', width: 40, depth: 40, height: 60, model: '/models/pendantLamp.obj', icon: '/models/pendantLamp.png', placementType: 'ceiling' },
